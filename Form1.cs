...
namespace EX03
{
    public partial class frmPrincipal : Form
    {
        ...
        private void btnAdicionarProduto_Click(object sender, EventArgs e)
        {
          ...
          //  txtQuantidade.KeyPress += new KeyPressEventHandler(txtQuantidade.Text.KeyPress);
        


            if (txtQuantidade.Text != string.Empty && txtCodigoBarras.Text !=string.Empty 
                && txtDescricao.Text != string.Empty && txtPrecoUnitario.Text != string.Empty)
